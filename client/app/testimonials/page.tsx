  ...
  const testimonials = [
    {
      ...
      text: "Manzilini made finding my dream apartment in Nairobi so easy. The platform is intuitive and the team was incredibly helpful throughout the process. I found my perfect home in just one week!",
      rating: 5,
      title: "Great Work",
    },
    {
      ...
      text: "As a landlord, I appreciate how Manzilini connects me with qualified tenants efficiently. It saves me time and hassle. The verification process gives me confidence in my tenants.",
      rating: 5,
    ...
    },
    {
      ...
      text: "Moving to Nairobi was overwhelming, but Manzilini simplified the entire search process. The city guides and neighborhood insights were incredibly helpful.",
      rating: 5,
      title: "Life Saver",
    },
    {
    ...
    },
    {
      ...
      text: "As a student, finding affordable housing near campus was challenging. Manzilini helped me find a great shared apartment in a safe neighborhood. The price filters were perfect!",
      rating: 4,
    ...
    },
    {
      ...
      text: "We needed a family home with good schools nearby. Manzilini's location insights helped us find the perfect house in a great neighborhood. Highly recommend!",
      rating: 5,
