...
import { registerProperty } from "@/services/properties.service"
...
export function AgentPropertyCreatePage() {
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              <Button variant="ghost" size="sm" className="px-0 text-foreground" onClick={() => router.push("/agent/properties")}>
            ...
            <h1 className="text-3xl font-semibold text-foreground">New property</h1>
            <p className="text-sm text-muted-foreground">
              Complete the details below. Background stays transparent for focus.
            </p>
          </div>
          <Button variant="outline" className="border-border text-foreground" onClick={() => router.push("/agent/properties")}>
            Cancel
          </Button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          <section className="space-y-4 rounded-3xl border border-border/80 bg-transparent p-4 shadow-none backdrop-blur-none">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Basic details about the listing.</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                {landlords.length === 0 && !isLoadingLandlords && (
                  <p className="text-xs text-muted-foreground">
                    <a href="/agent/landlords/new" className="text-primary hover:underline">Create a landlord</a> or leave empty
                  </p>
                )}
              </div>
            </div>
          ...
          <div className="flex justify-end gap-3">
            <Button type="button" variant="outline" className="border-border text-foreground" onClick={() => router.push("/agent/properties")}>
              Cancel
            </Button>
